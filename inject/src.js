...
function addFlagsToProgram() {
    if (programData.creatorProfile.nickname && programData.scratchpad.kaid !== KA._userProfileData.kaid && !KA._userProfileData.isModerator) {
...
function showProgramsFlags() {
    ...
    console.log("Loaded all Hot List flags.");
